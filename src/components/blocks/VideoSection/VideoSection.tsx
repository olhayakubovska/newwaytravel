...
//           </motion.div>
//         )}
//         {/* Блок похожих видео внутри модалки */}
//               {activeVideo.relatedVideos && activeVideo.relatedVideos.length > 0 && (
//                 <div className={styles.relatedContainer}>
//                   <p className={styles.relatedLabel}>Показать другие видео</p>
//                   <div className={styles.relatedList}>
//                     {activeVideo.relatedVideos.map((relVideo) => (
//                       <div
//                         key={relVideo.id}
//                         className={styles.relatedCard}
//                         onClick={() => setActiveVideo(relVideo)}
//                       >
...
//                           </div>
//                         </div>
//                         <span className={styles.relatedCardTitle}>{t(relVideo.title)}</span>
//                       </div>
//                     ))}
//                   </div>
//                 </div>
