...
// // Рекурсивная функция для перевода текстов внутри блоков
...
//       // Переводим только строки, которые похожи на контент (длиннее 1 символа)
//       // И не переводим системные поля (id, blockType)
//       if (
//         typeof value === 'string' &&
//         value.length > 1 &&
//         key !== 'id' &&
...
//             // ТЕПЕРЬ МЫ ПЕРЕВОДИМ ВНУТРЕННОСТИ БЛОКОВ
...
//           }
//         }, 200) // Увеличил задержку до 200мс для надежности
//       }
//     }
//     return doc
//   }
